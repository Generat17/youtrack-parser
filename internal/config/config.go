...
# Остальные настройки
agile_id: "83-1793"
skip_drafts: true # Пропускать черновики? true/false
# Список состояний, которые необходимо получить.
# Все возможные состояния: Backlog, Canceled, Deployed, Done, In Deployment, In Progress, In Review, Open, Testing
state_whitelist:
  - "Backlog"
  - "Canceled"
  - "Deployed"
...
# список имен для нормализации имяYouTrack -> Нормальное имя, если нужно, можно добавить гипперссылку на тг
normal_names:
